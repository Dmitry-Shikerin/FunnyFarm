...
using Sources.Frameworks.MVVM.DomainServices.Factories;
...
namespace Sources.Frameworks.MVVM.Presentation.Binders
{
    public class Binder : IBinder
    {
        ...
        {
            //TODO ищем здесь поля в моделвью?
        ...
        //TODO не используются входящие параметры
